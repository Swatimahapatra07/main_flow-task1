...
if redbull_var.get() == 0:
    ...
    messagebox.showerror("error", "please fill the redbull quantity") redbull_q = 0
...
total_coffee_price = coffee_price int(coffee_q) total_tea_price tea_price* int(tea_q)
...
# Calculator code
def nine():
    if 'error' in result.get() of '=' in result.get():
        result.delete(0,"end")
        result.insert("end","9")
    else:
        result.insert("end","9")
...
def clear():
    ...
    Label(innerframe5, text="Bill Details", font=('verdana', 10, 'bold'))
    Lplace(x=40,y=100)
...
def send_bill():
    ...
    if ph_number == "":
        ...
        send_msg = Button(innerframe5, text="Send Bill", relief RAISED, borderwidth=2, font=('verdana', 8, 'bold'), bg='#248aa2", fg="white", padx=20,command=se send_msg.place(x=100,y=255)
        send_msg.place(x=100,y=255)
        root.mainloop()

#Exit button code
def exit():
    message messagebox.askquestion ('Notepad", "Do you want to exit the application") if message == "yes":
    root.destroy()
    else:
    "return"
def cleared_bill():
...
drinks_cost.delete(0, 'end')
foods_cost.delete(0, 'end')
service charge_cost.delete(0, 'end')
service_charge_cost.delete(0, 'end')
paid_tax_cost.delete(e, 'end')
sub_total_cost.delete(0, 'end')
total_cost_cost.delete(0,'end')
# Bill Details
bill_details.delete(1.0, 'end')
...
frame.place(x=0,y=0)
Label(frame, text="Restaurent Management System", font=('roboto', 30, 'bold'), bg="#248aa2',fg="#ffffff")
Lplace(x=10,y=4)
frame1= Frame(root, width=450, height=230, relief RIDGE, borderwidth=5,bg='#248aa2')
frame1.place(x=0,y=70)
innerframe1 Frame (frame1, width=150, height=220, relief RIDGE, borderwidth=3,bg='#248aa2', highlightbackground="white", highlightcolor="white", highlight- innerframe1.place(x=0,y=0)
drinks = LabelFrame (innerframe1, text="Drinks", width=135, height=205, borderwidth=3, font=('verdana', 10, 'bold'), fg='#248aa2', relief RIDGE, highlightbackgre drinks.place(x=2,y=2)
lassi_var IntVar()
...
innerframe2 Frame (frame1, width=290, height=220,relief=RIDGE, borderwidth=3,bg='#248aa2', highlightbackground="white", highlightcolor="white", highlightt innerframe2.place (x=151,y=\theta)
foods = LabelFrame(innerframe2, text="Foods", width=275, height=205, borderwidth=3, font=('verdana', 18, 'bold'), fg='#248aa2", relief-RIDGE, highlightbackgroun foods.place (x=2,y=2)
roti_var IntVar()
...
frame2.place (x=\theta,y=3\theta\theta)
innerframe3 Frame (frame2, width=440, height=80, relief RIDGE, borderwidth=3, bg='#248aa2', highlightbackground="white", highlightcolor="white", highlightth innerframe3.place(x=0,y=0)
...
sub_total.place x=25\theta y=24)
sub_total_cost Entry(innerframe3, width=13, berderwidth=4, relief=SUNKEN)
sub_total_cost.place( x=330 y=22)
total_cost Label(innerframe3, text="Total Cost", font=('verdana', 8, 'bold'))
total_cost.place (x=25\theta,y=46)
total_cost_cost Entry(innerframe3, width=13, borderwidth=4, relief-SUNKEN)
total_cost_cost.place( x=33\theta, y=44)
frame3= Frame(root, width=200, height=320, relief=RIDGE, borderwidth=5, bg='#248aa2') frame3.place(x=450,y=70)
innerframe4 Frame (frame3, width=190,height=310, relief=RIDGE, borderwidth=3,bg="#248aa2', highlightbackground="white", highlightcolor="white", highlightt innerframe4.place(x=0,y=0)
...
plus Button (innerframe4, text="+", padx=6, relief RAISED, borderwidth=2, font=('verdana', 18, 'bold'), bg='white', fg="black", command=plus) plus.place(x=144,y=24)
...
four Button(innerframe4, text="4", padx=15, relief RAISED, borderwidth=2, font=("verdana', 10, 'bold'), bg='#248aa2", fg="white", command=four) four.place(x=96,y=50)
minus Button (innerframe4, text="-", padx=8, relief RAISED, borderwidth=2, font=('verdana', 10, 'bold'), bg='white', fg="black", command=minus) minus.place(x=144,y=50)
three = Button(innerframe4, text="3", padx=15, relief RAISED, borderwidth=2, font=("verdana', 18, 'bold'), bg='#248aa2',fg="white", command=three)
three.place(x=0,y=76) two = Button(innerframe4, text="2", padx=15, relief RAISED, borderwidth=2, font=('verdana', 10, 'bold'), bg="#248aa2',fg="white", command=two) two.place(x=48,y=76)
one = Button(innerframe4, text="1", padx=15, relief RAISED, borderwidth=2, font=('verdana', 10, 'bold'), bg="#248aa2", fg="white", command=one) one.place(x=96,y=76)
...
send Button (innerframe4, text="Send", relief RAISED, borderwidth=2, font=('verdana', 8, 'bold'), bg='#248aa2',fg="white", command=Send) send.place(x=82,y=275)
exit Button (innerframe4, text="Exit", relief RAISED, borderwidth=2, font=('verdana', 8, 'bold'), bg='#248aa2',fg="white", command=exit) exit.place(x=124,y=275)
clr= Button(innerframe4, text="C", relief RAISED, borderwidth=2, font=('verdana', 8, 'bold'), bg='#248aa2',fg="white", command=cleared_bill) clr.place(x=160,y=275)
root.mainloop()
